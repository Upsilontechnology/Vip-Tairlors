    ...
    <>
      <li className="relative px-2 py-1">
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "inline-flex items-center font-bold text-[#3d48df] hover:text-blue-600 text-base "
              : "inline-flex items-center font-semibold hover:text-blue-600 text-base"
          }
          to="employeeHome"
        >
      ...
      <li className="relative px-2 py-1 ">
        ...
        >
          ...
          <span className="ml-2">Add Ordered Product</span>
        </NavLink>
      </li>
      <li className="relative px-2 py-1 ">
        <NavLink
        ...
        >
          ...
          <span className="ml-2">Ordered List</span>
        </NavLink>
      </li>
    </>
  );

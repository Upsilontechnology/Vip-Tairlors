...
const AdminTabs = ({ allOrderProducts }) => {
  ...
  const totalSells = soldItemsInfo?.reduce(
    (total, product) => total + parseInt(product?.price),
    0
  );
  const totalSellsByCategory = selectedData?.reduce(
    (total, product) => total + parseInt(product?.price),
    0
  );
  const totalqunatity = selectedData?.reduce(
      ...
      <Tabs>
        ...
        <div className="flex lg:flex-row flex-col w-full gap-5">
          ...
          <TabList className="font-bold md:w-2/3 w-5/6 mx-auto py-4 bg-gray-100 flex flex-row justify-center items-center gap-2 md:gap-4 lg:gap-10 rounded-md">
            <Tab
              className="border-none bg-white md:py-5 py-2 md:px-14 px-4 rounded-md cursor-pointer"
              selectedClassName="selected-tab bg-yellow-950 text-white md:py-5 py-2 md:px-14 px-4"
            >
              Sell Product
            </Tab>
            <Tab
            ...
            <div className="flex items-center justify-between mb-3 mt-2 md:px-5 px-2">
              ...
              <div className="flex justify-end my-5">
                <div className="dropdown dropdown-hover mr-2 md:mr-5">
                  ...
                  <ul
                    tabIndex={0}
                    className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-28 font-bold"
                  >
                    <li>
                      <button
                    ...
                    <li>
                      <button
                        onClick={() => handleOrderFilter("daily")}
                        className=""
                      >
                        Today
                      </button>
                    ...
                    <li>
                      <button
                        onClick={() => handleOrderFilter("weekly")}
                        className=""
                      >
                        Weekly
                      </button>
                    ...
                    <li>
                      <button
                        onClick={() => handleOrderFilter("monthly")}
                        className=""
                      >
                        Monthly
                      </button>
                    ...
                    <li>
                      <button
                        onClick={() => handleOrderFilter("yearly")}
                        className=""
                      >
                        Yearly
                      </button>
    ...
    <Tabs>
      ...
      <div className="flex flex-row w-full gap-5">
        ...
        <TabList className="font-bold w-2/3 bg-gray-100 flex flex-row justify-center items-center gap-10 rounded-md">
          <Tab
            className="border-none bg-white py-5 px-14 rounded-md cursor-pointer"
            selectedClassName="selected-tab bg-yellow-950 text-white py-5 px-14"
          >
            Sell Product
          </Tab>
          <Tab
